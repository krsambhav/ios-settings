...
import { MdCable, MdCamera, MdCloud, MdCompareArrows, MdContacts, MdEditCalendar, MdEmergency, MdFiberManualRecord, MdGames, MdLinearScale, MdMessage, MdMusicNote, MdNotes, MdPhone, MdPhoto, MdPodcasts, MdPrivacyTip, MdRecordVoiceOver, MdShortcut, MdSignalWifi4Bar, MdTagFaces, MdTranslate, MdTv, MdVpnKey, MdWallpaper } from "react-icons/md";
        ...
        <div className="second-row w-[90%] pb-2 bg-white mx-auto mt-3 rounded-md font-thin text-xs flex flex-col gap-1 pl-3 pt-2">
          <div className="row flex flex-col gap-2 items-center w-[100%]">
            ...
            <div className="menu flex flex-row gap-2 items-center w-[100%]">
              ...
              <div className="text">Game Center</div>
            </div>
            <div className="menu flex flex-row gap-2 items-center w-[100%]">
              <div className="icon">
                <MdCable />
